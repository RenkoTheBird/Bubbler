...
**Related:** [`moderation.md`](moderation.md) (Phase 0 safety floor), [`TODO`](TODO) (pre-production features), [`architecture.md`](architecture.md), [`project_spec.md`](project_spec.md).
